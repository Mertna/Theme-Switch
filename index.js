	...
	function onInit(){  if (localStorage.getItem("theme") == "dark") { toggleTheme(); }  };
	
	function toggleTheme() {
		if (theme == "dark" || localStorage.getItem("theme") == null) {	stylesheet.href = "index-light.css"; theme = "light"; }
